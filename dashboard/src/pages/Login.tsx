    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-logo">
          <img src="/waforge_logo.jpg" alt={t('common.appName')} className="logo-icon" />
        </div>
        ...
        <p className="login-help">
          {t('login.help')}{' '}
          <a
            href="https://github.com/rmyndharis/WaForge/blob/main/docs/01-project-overview.md"
            target="_blank"
      ...
      <footer className="login-footer">
        ...
        <span className="login-footer-credit">
          {t('common.companyCredit')}{' '}
          <a href="https://www.quanturatech.com" target="_blank" rel="noopener noreferrer">
            quanturatech.com
          </a>
        </span>
      </footer>
