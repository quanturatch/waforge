<p align="center">
  <img src="logo/WaForge_logo.webp" alt="WaForge Logo" width="200"/>
</p>

<h1 align="center">WaForge Documentation</h1>
<p align="center">
...
<p align="center">
  <img src="https://img.shields.io/github/package-json/v/rmyndharis/WaForge?label=version&color=blue" alt="Version"/>
...
| 22  | [n8n Integration](./22-n8n-integration.md)                       | n8n community nodes for WaForge                    |
| 23  | [Community Integrations](./23-community-integrations.md)         | Third-party adapters built on the WaForge API      |
...
| [Webhook Signature Verification](./examples/webhook-signature-verification.md) | Verify signed WaForge webhook deliveries in Node.js and Python |
| [n8n Appointment Booking Workflow](./examples/n8n-appointment-booking.md) | Build an appointment-booking flow with WaForge and n8n |
...
```bash
# Clone repository
git clone https://github.com/rmyndharis/WaForge.git
cd WaForge
...
WaForge seeds a default API key on first run and writes it to:
...
curl -X POST http://localhost:2785/api/sessions/{sessionId}/messages/send-text \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{"chatId": "628123456789@c.us", "text": "Hello from WaForge!"}'
```
...
_WaForge Documentation · Last updated: 2026-06-18_
