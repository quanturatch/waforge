...
```mermaid
timeline
    title WaForge Release Timeline
...
├── Docker image (ghcr.io/rmyndharis/WaForge:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/rmyndharis/WaForge:0.0.2)
...
├── Docker image (ghcr.io/rmyndharis/WaForge:0.1.0)
...
| ---------------------- | -------- | ------ | ------------------------------- |
| JavaScript/Node.js SDK | P1       | ✅ Shipped (`@rmyndharis/WaForge`) | Official client library |
| Python SDK             | P2       | ✅ Shipped (`rmyndharis-WaForge`) | Python client library |
| PHP SDK                | P2       | ✅ Shipped (`rmyndharis/WaForge`) | PHP client library |
...
| Feature                | Priority | Status | Description                      |
| ---------------------- | -------- | ------ | -------------------------------- |
| Prometheus Metrics     | P1       | ✅ Shipped (`GET /api/metrics`, `WaForge_*`) | /metrics endpoint for monitoring |
