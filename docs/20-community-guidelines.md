...
WaForge is committed to providing a welcoming and inclusive environment for everyone. We pledge to make participation in our project and community a harassment-free experience for all, regardless of:
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/WaForge.git
cd WaForge

# 3. Add upstream remote
git remote add upstream https://github.com/rmyndharis/WaForge.git
...
- **Q&A**: Questions about using WaForge
- **Ideas**: Feature suggestions and brainstorming
- **Show and Tell**: Share your projects using WaForge
...
Channels:
- `#general` - General discussion
- `#support` - Help with WaForge
- `#development` - Development discussions
- `#showcase` - Share your projects
- `#off-topic` - Non-WaForge discussions
...
Thanks to all the people who have contributed to WaForge!
