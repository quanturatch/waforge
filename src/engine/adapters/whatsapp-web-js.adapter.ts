 ...
 * often a persistent browser profile left stale by an WaForge upgrade that changed the Chromium/Chrome
  ...
  async initialize(callbacks: EngineEventCallbacks): Promise<void> {
    ...
    try {
      ...
      if (isExecutionContextDestroyedError(reason)) {
        ...
        this.logger.warn(
          `"${reason}" during initialize. If this followed an WaForge upgrade that changed the ` +
